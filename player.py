...
root = Tk()
root.title('Aqua MP3 Player')
root.iconbitmap('c:/users/lyuti/desktop/krl/images/icon.ico')
...
def play_time():
    ...
    song = f'C:/Users/lyuti/Desktop/krl/audio/{song}.mp3'
...
def add_song():
    ...
    song = song.replace("C:/Users/lyuti/Desktop/krl/audio/", "")
